...
/**
 * /xq-characters2/[code] — 3D variant of the preview route. Renders
 * the full /xq-quiz ResultsScreen with the 3D character renderer
 * substituted in (XQCharacter3D) for both the reveal portrait and
 * the spectrum-map anchor thumbnails.
 *
...
function PreviewBanner({ code }: { code: ArchetypeCode }) {
  return (
    ...
    >
      <span>
        PREVIEW · {code} reveal (3D) · mock data — not a real submission.
      </span>
      <Link
        href="/xq-characters2"
        style={{
