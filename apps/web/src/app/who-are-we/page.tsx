...
export default function WhoAreWePage() {
  return (
    <main className={styles.page}>
      ...
      {/* Impact + Stories sections briefly lived here (commit 37064e7
          for code, SESSION_LOG_2026-06-09 for design intent) — pulled
          back out until we have real metrics + real testimonial
          quotes. Cherry-pick that commit when ready to re-enable. */}
