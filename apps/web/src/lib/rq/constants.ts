...
export const DESCRIPTIONS = {
  Values: {
    F: [
      ...
      'F (4–6) — Intentionally Grounded. You can name your values clearly when it matters, but you don\'t lead with them at every turn. The upside is balance: enough clarity to anchor trust without narrowing your audience unnecessarily. You want partners who "get it" without performative agreement. Look for matches who can articulate alignment in context, keep messaging natural, and treat your values as a compass—not a costume.',
      "F (7–10) — Explicitly Formative. Your convictions are central to your identity and impact, and you're comfortable naming them. The upside is deep resonance with the people you're meant to serve; the tradeoff is selectivity. You want partners who are unembarrassed about what they stand for and who won't dilute shared convictions for convenience. Look for matches with clear principles, honest boundaries, and a desire to build trust through clarity.",
    ],
    I: [
  ...
  Authenticity: {
    ...
    S: [
      ...
      "S (4–6) — Intentionally Structured. You value coherence and clarity, but you're not rigid. The upside is trust through consistency—people know what to expect from you. You want partners who respect tone and framing without sounding scripted. Look for matches who can align to your structure, keep messaging clean, and treat consistency as a form of care for your audience.",
      "S (7–10) — Highly Structural. You steward voice and messaging with precision; authenticity comes through coherence, craft, and intentionality. The upside is clarity and integrity at scale; the risk is stiffness if partners can't fit the frame. You want collaborators who appreciate structure as respect, not control. Look for matches who can operate within clear guardrails, communicate with rigor, and help your signal stay unmistakably yours.",
    ],
  },
  Horizon: {
    L: [
